xdescribe('MntDetailCtrl', function() {

    var $scope, ctrl;

    // mocks
    var mountainsMock, resultsMock, testStateParams;
    ...
    beforeEach(inject(function($q, $controller, $rootscope) {
        ...
        // mock the Mountains service
         //inject(function($q) {
             ...
             mountainsMock = {
             all: jasmine.createSpy('all spy').and.returnValue(0),//deferredMountainsService.promise),
             remove: jasmine.createSpy('remove spy').and.returnValue(0),//deferredMountainsService.promise),
             get: jasmine.createSpy('get spy').and.returnValue(0),//deferredMountainsService.promise),
             ...
             resultsMock = {
                 push: jasmine.createSpy('push spy').and.returnValue(0),
                 get: jasmine.createSpy('get spy').and.returnValue(0),
                 getAll: jasmine.createSpy('getAll spy').and.returnValue(0),
                 clearAll: jasmine.createSpy('clearAll spy').and.returnValue(0)
             };
